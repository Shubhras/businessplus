...
class CreateProductsServicesTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Products_services", 'products_services', 'test_products', 'fa-cube', [
            ["test_products", "test_products", "Address", false, "20", 0, 256, false],
        ]);
    ...
    {
        if (Schema::hasTable('products_services')) {
