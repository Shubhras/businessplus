...
class CreateFunctionModsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Function_mods", 'function_mods', 'function_name', 'fa-cube', [
            ["unit_id", "Select Unit", "Dropdown", false, "", 0, 0, false, "@units"],
            ["function_name", "Function Name", "TextField", false, "", 0, 256, false],
            ["function_details", "Function Details", "Textarea", false, "", 0, 0, false],
            ["function_owner", "Function Owner", "Dropdown", false, "", 0, 0, false, "@employers"],
        ]);
