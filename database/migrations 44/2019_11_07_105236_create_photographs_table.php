...
class CreatePhotographsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Photographs", 'photographs', 'test_photograph', 'fa-cube', [
            ["test_photograph", "test_photograph", "Address", false, "20", 0, 256, false],
        ]);
    ...
    {
        if (Schema::hasTable('photographs')) {
