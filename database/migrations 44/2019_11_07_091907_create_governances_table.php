...
class CreateGovernancesTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Governances", 'governances', 'governances_test', 'fa-cube', [
            ["governances_test", "governances_test", "Address", false, "20", 0, 256, false],
        ]);
    ...
    {
        if (Schema::hasTable('governances')) {
