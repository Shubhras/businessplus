...
class CreateEmployersTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Employers", 'employers', 'name', 'fa-cube', [
            ["multi_section_id", "Select Sections", "TextField", false, "", 0, 256, false,],
            ["reason_model_name", "Reason Model Name", "TextField", false, "", 0, 256, false],
            ["company_id", "company id", "TextField", false, "", 0, 50, false],
            ["reset_password_token", "reset_password_token", "TextField", false, "", 0, 256, false],
            ["multi_unit_id", "Multi Unit", "TextField", false, "", 0, 256, true,],
            ["multi_dept_id", "Multi Dept", "TextField", false, "", 0, 256, true,],
