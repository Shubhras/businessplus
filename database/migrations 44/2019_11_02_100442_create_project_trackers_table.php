...
class CreateProjectTrackersTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Project_trackers", 'project_trackers', 'permission', 'fa-cube', [
            ["permission", "permission", "TextField", false, "20", 0, 256, false],
        ]);
    ...
    {
        if (Schema::hasTable('project_trackers')) {
            Schema::drop('project_trackers');
        }
    }
}
