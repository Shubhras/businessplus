...
class CreateManagementReportsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Management_reports", 'management_reports', 'text_test', 'fa-cube', [
            ["text_test", "text_test", "TextField", false, "", 0, 10, false],
        ]);
    ...
    {
        if (Schema::hasTable('management_reports')) {
            Schema::drop('management_reports');
        }
    }
}
