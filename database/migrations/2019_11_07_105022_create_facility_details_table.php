...
class CreateFacilityDetailsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Facility_details", 'facility_details', 'facility_test', 'fa-cube', [
            ["facility_test", "facility_test", "Address", false, "20", 0, 256, false],
        ]);
    ...
    {
        if (Schema::hasTable('facility_details')) {
