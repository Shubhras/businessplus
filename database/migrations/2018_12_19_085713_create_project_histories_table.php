...
class CreateProjectHistoriesTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Project_histories", 'project_histories', 'project_id', 'fa-cube', [
            ["project_id", "Project Name", "Dropdown", false, "", 0, 0, false, "@projects"],
            ["status_id", "Status", "Dropdown", false, "", 0, 0, false, "@statuses"],
