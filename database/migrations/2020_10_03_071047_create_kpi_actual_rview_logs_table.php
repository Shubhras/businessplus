...
class CreateKpiActualRviewLogsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Kpi_actual_rview_logs", 'kpi_actual_rview_logs', 'kpi_id', 'fa-cube', [
            ["kpi_id", "kpi_id", "Integer", false, "", 0, 10, false],
            ["month", "month", "TextField", false, "", 0, 10, false],
            ["actual_year", "actual_year", "Integer", false, "", 0, 10, false],
        ]);
