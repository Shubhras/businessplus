...
class CreateMasterPlansTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Master_plans", 'master_plans', 'master-plan', 'fa-cube', [
            ["master-plan", "demo", "TextField", false, "", 0, 20, false],
        ]);
    ...
    {
        if (Schema::hasTable('master_plans')) {
            Schema::drop('master_plans');
        }
    }
}
