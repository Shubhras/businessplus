...
class CreateUserSetupsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("User_setups", 'user_setups', 'test_user', 'fa-cube', [
            ["test_user", "test_user", "TextField", false, "", 0, 5, false],
        ]);
    ...
    {
        if (Schema::hasTable('user_setups')) {
            Schema::drop('user_setups');
        }
    }
}
