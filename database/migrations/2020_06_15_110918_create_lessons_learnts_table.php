...
class CreateLessonsLearntsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Lessons_learnts", 'lessons_learnts', 'test_lessons', 'fa-cube', [
            ["test_lessons", "test_lessons", "TextField", false, "", 5, 256, false],
        ]);
    ...
    {
        if (Schema::hasTable('lessons_learnts')) {
            Schema::drop('lessons_learnts');
        }
    }
}
