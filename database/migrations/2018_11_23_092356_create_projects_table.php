...
class CreateProjectsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Projects", 'projects', 'project_name', 'fa-cube', [
            ["project_step_id", "project_step_id", "Integer", false, "", 0, 11, false],
            ["currency", "currency", "TextField", false, "", 0, 20, false],
            ["project_logo", "project_logo", "TextField", false, "", 0, 50, false],
            ["key_objective", "key_objective", "TextField", false, "", 0, 256, false],
            ["project_mission", "project_mission", "TextField", false, "", 0, 256, false],
            ["company_id", "company_id", "Integer", false, "", 0, 20, false],
            ["project_cost", "project_cost", "Integer", false, "", 0, 20, false],
            ["project_duration", "project_duration", "TextField", false, "", 0, 50, false],
            ...
            ["user_id", "Owner", "Dropdown", false, "", 0, 0, false, "@users"],
