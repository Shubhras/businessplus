...
class CreateEmployersTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Employers", 'employers', 'name', 'fa-cube', [
            ...
            ["date_birth", "Date Of Birth", "Date", false, "date("Y-m-d")", 0, 0, false],
            ["date_hire", "Date Of Hire", "Date", false, "date("Y-m-d")", 0, 0, false],
            ["dept_master_id", "Select Department ", "Dropdown", false, "", 0, 0, false, "@department_masters"],
            ["unit_id", "Select Unit", "Dropdown", false, "", 0, 0, false, "@units"],
            ["section_id", "Select Section", "Dropdown", false, "", 0, 0, false, "@sections"],
