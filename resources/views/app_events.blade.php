                    ...
                    <ul>
                        ...
                        <li class="has_sub">
                            <a href="javascript:void(0);" class="waves-effect waves-primary">
                                <i class="ti-shine"></i><span> Task Tracker </span>
                                <span class="badge badge-pink pull-right">New</span>
                            </a>
                            <ul class="list-unstyled">
                                <li><a href="apps-tickets.html">Dashboard</a></li>   
                                 <li><a href="app-events.html">Event</a></li>
                                <li><a href="apps-project.html">Project</a></li>
                            <li><a href="apps-taskassign.html">Task Assigned</a></li>
                    <li><a href="apps-taskforme.html">Task For Me</a></li>
                     <!--
                         ...
                         <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect waves-primary">
                                    <i class="ti-shine"></i><span> KPI Trackers </span> 
                                    <span class="badge badge-pink pull-right">New</span> 
                                </a>
                                <ul class="list-unstyled">
                    <li><a href="apps-tickets.html">Dashboard</a></li>   
                   <li><a href="KPI Overview.html">Overview</a></li>
                    <li><a href="KPI-Strategic-Object.html">Strategic Object</a></li>
              <!--   <li><a href="apps-kanban.html">Kanban Board</a></li>
                                <li><a href="apps-companies.html">Companies</a></li>
                                <li><a href="apps-filemanager.html">File Manager</a></li>
                                <li><a href="apps-tickets.html">Tickets</a></li>
        ...
        <div class="content-page">
            ...
            <div class="content">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-6 col-sm-3">
                                                <div class="card-box bg-danger text-white">
                                                    ...
                                                    <p class="text-uppercase m-b-5 font-13 font-weight-medium">Deleted Tickets</p>
                                                </div>
                                            </div> 
                                        </div> 
                                    </div> -->
                         <div class="popup_btn">
                       <button type="button" class="btn btn-info btn-lg btn-intext" data-toggle="modal" data-target="#myModal">Add Event</button>
                        </div>
                  <!-- Modal -->
              ...
              <!-- Modal content-->
               ...
               <hAdd categeries4 class="modal-title">Events</h4>
                </div>
                       <div class="modal-body">
                         <label>Id</label>
                           <input type="text" name="" style="width: 300px; margin-left: 80px;">
                        </div>
                       <div class="modal-body">
                         <label>Event</label>
                        ...
                        <div class="modal-body">
                           ...
                           <input type="text" name="" style="width: 300px; margin-left: 30px;">
                        </div>
                         <div class="modal-body">
                           <label>Status</label>
                           <input type="text" name="" style="width: 300px; margin-left: 48px;">
                        </div>
                         <div class="modal-body">
                        <label>Action</label>
                                ...
                                <table class="table table-hover m-0 table-centered dt-responsive nowrap" cellspacing="0" width="100%" id="datatable">
                                    <thead class="bg-light">
                                        <tr>
                                            ...
                                            <th class="font-weight-medium">Events</th>
