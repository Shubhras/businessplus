                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#ffffff">
                              <tbody>
                                <tr>
                                  ...
                                  <img alt="Primaplus" width="80" src="http://139.59.83.155/stagebusinessplus/publicstorage/email/cropped-logo-small-final.png"/>

                                  </td>
                                </tr>
                                <tr>
                                    <td align="center">
                                      <span style="color:#48545d;font-size:19px;;line-height:24px;">
Thank you for creating an account with PrimaPlus.
                                ...
                                <tr>
                                  <td align="center"> <span style="color:#48545d;font-size:22px;line-height: 24px;">
                                    BusinessPlus.com login credential
                                  </span>
                                ...
                                <tr>
                                  <td align="center"> <span style="color:#48545d;font-size:22px;line-height: 24px; margin-top: 20px;">
                                    <b>UserName - <?php echo $email ?></b>
                                  </span>
          ...
          <a href="#" style="display:block; padding:15px 25px; background-color:#61C7FF; color:#ffffff; border-radius:3px; text-decoration:none; font-size:16px;">Businessplus.com login credential</a>
        </span>
                                ...
                                <tr>
                                  <td align="center">
                                    <p style="color:#a2a2a2; font-size:12px; line-height:17px; font-style:italic;">If you did not sign up for this account you can ignore this email.</p>
                                  </td>
                                </tr>
