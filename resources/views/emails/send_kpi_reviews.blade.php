                            ...
                            <tbody>
                              <tr>
                                <td align="center" valign="bottom" colspan="2" cellpadding="3">
                                  <img alt="Primaplus" width="180" src="https://examwatch.website/prima/wp-content/uploads/2022/02/cropped-logo-small-final.png" />
                                </td>
                              </tr>
                              <tr>
                                                                <td align="center"> <span
                                                                        style="color:#48545d;font-size:19px;;line-height:24px;">
                              ...
                              <tr>
                                <td align="center"> <span style="color:#48545d;font-size:22px;line-height: 24px;">
                                    BusinessPlus Target Actual Review
                                  </span>
                                </td>
                              </tr>
                              <tr>
                              ...
                              <tr>
                                <td align="center"> <span style="color:#48545d;font-size:22px;line-height: 24px; margin-top: 20px;">
                                    <b>Actual Year - {{$actual_year}}</b>
                                  </span>
                                </td>
                              </tr>
                              <tr>
                                <td align="center"> <span style="color:#48545d;font-size:22px;line-height: 24px; margin-top: 20px;">
                                    <b>Kpi Name - {{$kpi_name}}</b>
                                  </span>
                                </td>
                              </tr>
                              <tr>
                                <td align="center"> <span style="color:#48545d;font-size:22px;line-height: 24px; margin-top: 20px;">
                                    <b>Dept Name - {{$dept_name}}</b>
                                  </span>
                                </td>
                              </tr>
                              <tr>
