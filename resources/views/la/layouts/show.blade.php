...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $layout->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Layouts", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/layouts/'.$layout->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Layouts", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.layouts.destroy', $layout->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/layouts') }}" data-toggle="tooltip" data-placement="right" title="Back to Layouts"><i class="fa fa-chevron-left"></i></a></li>
