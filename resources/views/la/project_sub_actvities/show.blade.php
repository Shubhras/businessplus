...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $project_sub_actvity->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Project_sub_actvities", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/project_sub_actvities/'.$project_sub_actvity->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Project_sub_actvities", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.project_sub_actvities.destroy', $project_sub_actvity->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/project_sub_actvities') }}" data-toggle="tooltip" data-placement="right" title="Back to Project sub actvities"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'major_activity_id')
						@la_display($module, 'sub_activity_name')
						@la_display($module, 'sb_actvity_strt_date')
						@la_display($module, 'sb_actvity_end_date')
						@la_display($module, 'project_id')
						@la_display($module, 'sub_activity_sr_no')
					</div>
				</div>
			</div>
		</div>
