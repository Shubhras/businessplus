...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $company_profile->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Company_profiles", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/company_profiles/'.$company_profile->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Company_profiles", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.company_profiles.destroy', $company_profile->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/company_profiles') }}" data-toggle="tooltip" data-placement="right" title="Back to Company profiles"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'company_address')
						@la_display($module, 'enable')
						@la_display($module, 'company_logo')
						@la_display($module, 'user_id')
						@la_display($module, 'company_step_id')
					</div>
				</div>
			</div>
		</div>
