...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $hoshin_kanri->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Hoshin_kanris", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/hoshin_kanris/'.$hoshin_kanri->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Hoshin_kanris", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.hoshin_kanris.destroy', $hoshin_kanri->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/hoshin_kanris') }}" data-toggle="tooltip" data-placement="right" title="Back to Hoshin kanris"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'dept_id')
						@la_display($module, 'str_obj_id')
						@la_display($module, 'initiatives_id')
						@la_display($module, 'action_plan_id')
						@la_display($module, 'kpi_id')
						@la_display($module, 'area_manager')
						@la_display($module, 'area_manager_value')
						@la_display($module, 'area_manager_percent')
						@la_display($module, 'dept_head')
						@la_display($module, 'dept_head_value')
						@la_display($module, 'dept_head_percent')
						@la_display($module, 'section_head')
						@la_display($module, 'section_head_value')
						@la_display($module, 'section_head_percent')
						@la_display($module, 'supervisor_head')
						@la_display($module, 'superv_head_value')
						@la_display($module, 'superv_head_percent')
