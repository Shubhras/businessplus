...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $str_object_gard->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Str_object_gards", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/str_object_gards/'.$str_object_gard->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Str_object_gards", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.str_object_gards.destroy', $str_object_gard->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/str_object_gards') }}" data-toggle="tooltip" data-placement="right" title="Back to Str object gards"><i class="fa fa-chevron-left"></i></a></li>
