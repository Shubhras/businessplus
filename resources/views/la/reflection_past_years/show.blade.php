...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $reflection_past_year->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Reflection_past_years", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/reflection_past_years/'.$reflection_past_year->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Reflection_past_years", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.reflection_past_years.destroy', $reflection_past_year->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/reflection_past_years') }}" data-toggle="tooltip" data-placement="right" title="Back to Reflection past years"><i class="fa fa-chevron-left"></i></a></li>
