...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $product_development->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Product_developments", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/product_developments/'.$product_development->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Product_developments", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.product_developments.destroy', $product_development->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/product_developments') }}" data-toggle="tooltip" data-placement="right" title="Back to Product developments"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'test_product')
					</div>
				</div>
			</div>
		</div>
