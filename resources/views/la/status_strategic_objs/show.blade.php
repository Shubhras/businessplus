...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $status_strategic_obj->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Status_strategic_objs", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/status_strategic_objs/'.$status_strategic_obj->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Status_strategic_objs", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.status_strategic_objs.destroy', $status_strategic_obj->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/status_strategic_objs') }}" data-toggle="tooltip" data-placement="right" title="Back to Status strategic objs"><i class="fa fa-chevron-left"></i></a></li>
