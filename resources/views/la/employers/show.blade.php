			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'multi_section_id')
						@la_display($module, 'reason_model_name')
						@la_display($module, 'company_id')
						@la_display($module, 'reset_password_token')
						@la_display($module, 'multi_unit_id')
						@la_display($module, 'multi_dept_id')
						...
						@la_display($module, 'dept_master_id')
						@la_display($module, 'section_id')
						@la_display($module, 'role_id')
						@la_display($module, 'pan_card_no')
