...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $kpi_actual->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Kpi_actuals", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/kpi_actuals/'.$kpi_actual->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Kpi_actuals", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.kpi_actuals.destroy', $kpi_actual->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/kpi_actuals') }}" data-toggle="tooltip" data-placement="right" title="Back to Kpi actuals"><i class="fa fa-chevron-left"></i></a></li>
