...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $project_gov_memeber->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Project_gov_memebers", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/project_gov_memebers/'.$project_gov_memeber->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Project_gov_memebers", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.project_gov_memebers.destroy', $project_gov_memeber->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/project_gov_memebers') }}" data-toggle="tooltip" data-placement="right" title="Back to Project gov memebers"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'project_gov_id')
						@la_display($module, 'member_id')
					</div>
				</div>
			</div>
		</div>
