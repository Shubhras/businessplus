...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $project_kpi_mileston->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Project_kpi_milestons", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/project_kpi_milestons/'.$project_kpi_mileston->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Project_kpi_milestons", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.project_kpi_milestons.destroy', $project_kpi_mileston->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/project_kpi_milestons') }}" data-toggle="tooltip" data-placement="right" title="Back to Project kpi milestons"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'project_kpi_sr_no')
						@la_display($module, 'milestone_id')
						@la_display($module, 'projct_kpi_dstrbt_vl')
						@la_display($module, 'project_kpi_id')
						@la_display($module, 'project_id')
						@la_display($module, 'project_kpi_actual')
						@la_display($module, 'project_kpi_reason')
						@la_display($module, 'project_kpi_solution')
						@la_display($module, 'project_kpi_status')
					</div>
				</div>
			</div>
		</div>
