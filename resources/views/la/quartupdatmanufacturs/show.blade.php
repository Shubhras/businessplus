...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $quartupdatmanufactur->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("QuartUpdatManufacturs", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/quartupdatmanufacturs/'.$quartupdatmanufactur->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("QuartUpdatManufacturs", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.quartupdatmanufacturs.destroy', $quartupdatmanufactur->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/quartupdatmanufacturs') }}" data-toggle="tooltip" data-placement="right" title="Back to QuartUpdatManufacturs"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'highlight')
						@la_display($module, 'majorgaps')
						@la_display($module, 'challenges')
						@la_display($module, 'priorities')
						@la_display($module, 'photo')
						@la_display($module, 'year')
						@la_display($module, 'quarterly')
