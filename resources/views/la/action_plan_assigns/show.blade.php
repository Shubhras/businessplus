...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $action_plan_assign->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Action_plan_assigns", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/action_plan_assigns/'.$action_plan_assign->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Action_plan_assigns", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.action_plan_assigns.destroy', $action_plan_assign->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/action_plan_assigns') }}" data-toggle="tooltip" data-placement="right" title="Back to Action plan assigns"><i class="fa fa-chevron-left"></i></a></li>
