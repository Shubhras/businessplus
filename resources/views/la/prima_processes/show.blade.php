...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $prima_process->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Prima_processes", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/prima_processes/'.$prima_process->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Prima_processes", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.prima_processes.destroy', $prima_process->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/prima_processes') }}" data-toggle="tooltip" data-placement="right" title="Back to Prima processes"><i class="fa fa-chevron-left"></i></a></li>
