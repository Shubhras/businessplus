...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $hk_supervisor_head->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Hk_supervisor_heads", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/hk_supervisor_heads/'.$hk_supervisor_head->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Hk_supervisor_heads", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.hk_supervisor_heads.destroy', $hk_supervisor_head->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/hk_supervisor_heads') }}" data-toggle="tooltip" data-placement="right" title="Back to Hk supervisor heads"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'hoshin_kanri_id')
						@la_display($module, 'allocation_id')
						@la_display($module, 'assign_user')
