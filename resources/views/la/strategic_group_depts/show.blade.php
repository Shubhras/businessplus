...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $strategic_group_dept->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Strategic_Group_Depts", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/strategic_group_depts/'.$strategic_group_dept->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Strategic_Group_Depts", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.strategic_group_depts.destroy', $strategic_group_dept->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/strategic_group_depts') }}" data-toggle="tooltip" data-placement="right" title="Back to Strategic Group Depts"><i class="fa fa-chevron-left"></i></a></li>
