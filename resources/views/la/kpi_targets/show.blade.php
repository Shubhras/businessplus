...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $kpi_target->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Kpi_targets", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/kpi_targets/'.$kpi_target->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Kpi_targets", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.kpi_targets.destroy', $kpi_target->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/kpi_targets') }}" data-toggle="tooltip" data-placement="right" title="Back to Kpi targets"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'sep')
						@la_display($module, 'year_end')
						@la_display($module, 'user_id')
						@la_display($module, 'ytd')
						@la_display($module, 'target_condition')
						@la_display($module, 'target_year')
						@la_display($module, 'dec')
						@la_display($module, 'nov')
						@la_display($module, 'oct')
						@la_display($module, 'kpi_id')
						@la_display($module, 'aug')
						@la_display($module, 'jul')
						@la_display($module, 'jun')
						@la_display($module, 'may')
						@la_display($module, 'apr')
						@la_display($module, 'mar')
						@la_display($module, 'feb')
						@la_display($module, 'jan')
					</div>
				</div>
			</div>
		</div>
