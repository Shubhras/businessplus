...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $status_business_plan->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Status_business_plans", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/status_business_plans/'.$status_business_plan->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Status_business_plans", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.status_business_plans.destroy', $status_business_plan->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/status_business_plans') }}" data-toggle="tooltip" data-placement="right" title="Back to Status business plans"><i class="fa fa-chevron-left"></i></a></li>
