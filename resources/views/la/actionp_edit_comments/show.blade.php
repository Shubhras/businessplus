...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $actionp_edit_comment->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Actionp_edit_comments", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/actionp_edit_comments/'.$actionp_edit_comment->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Actionp_edit_comments", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.actionp_edit_comments.destroy', $actionp_edit_comment->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/actionp_edit_comments') }}" data-toggle="tooltip" data-placement="right" title="Back to Actionp edit comments"><i class="fa fa-chevron-left"></i></a></li>
