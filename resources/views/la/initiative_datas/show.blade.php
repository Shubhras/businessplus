...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $initiative_data->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Initiative_datas", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/initiative_datas/'.$initiative_data->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Initiative_datas", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.initiative_datas.destroy', $initiative_data->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/initiative_datas') }}" data-toggle="tooltip" data-placement="right" title="Back to Initiative datas"><i class="fa fa-chevron-left"></i></a></li>
