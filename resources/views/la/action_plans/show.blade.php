...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $action_plan->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Action_plans", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/action_plans/'.$action_plan->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Action_plans", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.action_plans.destroy', $action_plan->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/action_plans') }}" data-toggle="tooltip" data-placement="right" title="Back to Action plans"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'sr_no')
						@la_display($module, 'previous_status')
						@la_display($module, 'reminder_date')
						@la_display($module, 'reminder_frequency')
						@la_display($module, 'definition')
						@la_display($module, 'target')
						@la_display($module, 'start_date')
						@la_display($module, 'control_point')
						@la_display($module, 'owner')
						@la_display($module, 'co_owner')
