...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $project_majr_actvity->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Project_majr_actvities", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/project_majr_actvities/'.$project_majr_actvity->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Project_majr_actvities", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.project_majr_actvities.destroy', $project_majr_actvity->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/project_majr_actvities') }}" data-toggle="tooltip" data-placement="right" title="Back to Project majr actvities"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'other_responsibility')
						@la_display($module, 'activity_name')
						@la_display($module, 'activity_start_date')
						@la_display($module, 'activity_end_date')
						@la_display($module, 'preceeding_activity')
						@la_display($module, 'next_activity')
						@la_display($module, 'responsibility')
						@la_display($module, 'milestone_id')
						@la_display($module, 'activity_sr_no')
