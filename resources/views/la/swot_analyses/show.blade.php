...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $swot_analysis->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Swot_analyses", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/swot_analyses/'.$swot_analysis->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Swot_analyses", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.swot_analyses.destroy', $swot_analysis->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/swot_analyses') }}" data-toggle="tooltip" data-placement="right" title="Back to Swot analyses"><i class="fa fa-chevron-left"></i></a></li>
