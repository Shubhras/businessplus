...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $add_kpi->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Add_kpis", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/add_kpis/'.$add_kpi->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Add_kpis", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.add_kpis.destroy', $add_kpi->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/add_kpis') }}" data-toggle="tooltip" data-placement="right" title="Back to Add kpis"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'lead_kpi')
						@la_display($module, 'start_date')
						@la_display($module, 'end_date')
						@la_display($module, 'frequency')
						@la_display($module, 'kpi_performance')
						@la_display($module, 's_o_id')
						@la_display($module, 'initiatives_id')
						@la_display($module, 'performance_dash')
						@la_display($module, 'kpi_name')
						@la_display($module, 'unit_id')
						@la_display($module, 'department_id')
						@la_display($module, 'target_condition')
						@la_display($module, 'ideal_trend')
						@la_display($module, 'kpi_type')
						@la_display($module, 'unit_of_measurement')
						@la_display($module, 'target_range_min')
						@la_display($module, 'target_range_max')
						@la_display($module, 'kpi_definition')
