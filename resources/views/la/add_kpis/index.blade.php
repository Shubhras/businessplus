...
@section("contentheader_title", "Add kpis")
@section("contentheader_description", "Add kpis listing")
@section("section", "Add kpis")
@section("sub_section", "Listing")
@section("htmlheader_title", "Add kpis Listing")

@section("headerElems")
@la_access("Add_kpis", "create")
	<button class="btn btn-success btn-sm pull-right" data-toggle="modal" data-target="#AddModal">Add Add kpi</button>
@endla_access
@endsection
	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="myModalLabel">Add Add kpi</h4>
			</div>
			{!! Form::open(['action' => 'LA\Add_kpisController@store', 'id' => 'add_kpi-add-form']) !!}
...
$(function () {
	$("#example1").DataTable({
		processing: true,
        serverSide: true,
        ajax: "{{ url(config('laraadmin.adminRoute') . '/add_kpi_dt_ajax') }}",
		language: {
			lengthMenu: "_MENU_",
			search: "_INPUT_",
