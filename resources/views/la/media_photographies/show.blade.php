...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $media_photography->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Media_photographies", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/media_photographies/'.$media_photography->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Media_photographies", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.media_photographies.destroy', $media_photography->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/media_photographies') }}" data-toggle="tooltip" data-placement="right" title="Back to Media photographies"><i class="fa fa-chevron-left"></i></a></li>
