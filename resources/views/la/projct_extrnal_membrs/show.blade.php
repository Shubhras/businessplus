...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $projct_extrnal_membr->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Projct_extrnal_membrs", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/projct_extrnal_membrs/'.$projct_extrnal_membr->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Projct_extrnal_membrs", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.projct_extrnal_membrs.destroy', $projct_extrnal_membr->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/projct_extrnal_membrs') }}" data-toggle="tooltip" data-placement="right" title="Back to Projct extrnal membrs"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'ex_membar_name')
						@la_display($module, 'department')
						@la_display($module, 'email_id')
