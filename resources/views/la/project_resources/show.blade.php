...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $project_resource->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Project_resources", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/project_resources/'.$project_resource->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Project_resources", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.project_resources.destroy', $project_resource->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/project_resources') }}" data-toggle="tooltip" data-placement="right" title="Back to Project resources"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'resource_uesr')
						@la_display($module, 'week')
						@la_display($module, 'actual')
						@la_display($module, 'project_id')
						@la_display($module, 'target')
						@la_display($module, 'externl_user')
					</div>
				</div>
			</div>
		</div>
