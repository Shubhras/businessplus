...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $big_data_service->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Big_data_services", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/big_data_services/'.$big_data_service->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Big_data_services", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.big_data_services.destroy', $big_data_service->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/big_data_services') }}" data-toggle="tooltip" data-placement="right" title="Back to Big data services"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'test_big_data')
					</div>
				</div>
			</div>
		</div>
