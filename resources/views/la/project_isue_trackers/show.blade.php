...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $project_isue_tracker->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Project_isue_trackers", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/project_isue_trackers/'.$project_isue_tracker->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Project_isue_trackers", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.project_isue_trackers.destroy', $project_isue_tracker->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/project_isue_trackers') }}" data-toggle="tooltip" data-placement="right" title="Back to Project isue trackers"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'issue_task_name')
						@la_display($module, 'issue_task_priority')
						@la_display($module, 'issue_task_dept')
						@la_display($module, 'issue_start_date')
						@la_display($module, 'issue_end_date')
						@la_display($module, 'issue_task_owner')
						@la_display($module, 'issue_task_co_owner')
						@la_display($module, 'issue_remindr_freq')
						@la_display($module, 'project_id')
						@la_display($module, 'issue_status')
						@la_display($module, 'completion_date')
						@la_display($module, 'issue_revised_date')
						@la_display($module, 'issue_task_reason')
					</div>
				</div>
			</div>
		</div>
