			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'has_videoposter')
						@la_display($module, 'audio_content')
						@la_display($module, 'video_content')
						@la_display($module, 'content')
						@la_display($module, 'status')
						@la_display($module, 'shared')
						@la_display($module, 'featured')
						@la_display($module, 'album_descr')
						@la_display($module, 'has_album')
						@la_display($module, 'has_audiobground')
						@la_display($module, 'shared_post_id')
						@la_display($module, 'has_ytbVideo')
						@la_display($module, 'has_thyme')
						@la_display($module, 'has_audio')
						@la_display($module, 'has_video')
						@la_display($module, 'has_image')
						@la_display($module, 'page_id')
						@la_display($module, 'group_id')
						@la_display($module, 'timeline_user_id')
