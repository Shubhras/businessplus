...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $str_obj_status->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Str_obj_statuses", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/str_obj_statuses/'.$str_obj_status->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Str_obj_statuses", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.str_obj_statuses.destroy', $str_obj_status->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/str_obj_statuses') }}" data-toggle="tooltip" data-placement="right" title="Back to Str obj statuses"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'min')
						@la_display($module, 'company_id')
						@la_display($module, 'color_code')
						@la_display($module, 'status_name')
						@la_display($module, 'accuracy_percentage')
					</div>
				</div>
			</div>
		</div>
