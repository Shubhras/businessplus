...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $u_o_m->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("U_o_ms", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/u_o_ms/'.$u_o_m->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("U_o_ms", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.u_o_ms.destroy', $u_o_m->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/u_o_ms') }}" data-toggle="tooltip" data-placement="right" title="Back to U o ms"><i class="fa fa-chevron-left"></i></a></li>
