...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $current_business_pln->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Current_business_plns", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/current_business_plns/'.$current_business_pln->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Current_business_plns", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.current_business_plns.destroy', $current_business_pln->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/current_business_plns') }}" data-toggle="tooltip" data-placement="right" title="Back to Current business plns"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'test_business_plan')
					</div>
				</div>
			</div>
		</div>
