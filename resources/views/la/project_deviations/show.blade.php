...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $project_deviation->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Project_deviations", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/project_deviations/'.$project_deviation->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Project_deviations", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.project_deviations.destroy', $project_deviation->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/project_deviations') }}" data-toggle="tooltip" data-placement="right" title="Back to Project deviations"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'deviation_name')
						@la_display($module, 'deviation_region')
						@la_display($module, 'deviation_risk')
						@la_display($module, 'deviation_start_date')
						@la_display($module, 'deviation_end_date')
						@la_display($module, 'deviation_qty')
						@la_display($module, 'deviation_dept')
						@la_display($module, 'deviation_aprove_usr')
