...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $business_plan->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Business_plans", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/business_plans/'.$business_plan->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Business_plans", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.business_plans.destroy', $business_plan->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/business_plans') }}" data-toggle="tooltip" data-placement="right" title="Back to Business plans"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'message_of_ceo')
						@la_display($module, 'vision')
						@la_display($module, 'mission')
						@la_display($module, 'company_id')
						@la_display($module, 'values')
						@la_display($module, 'highlights')
					</div>
				</div>
			</div>
		</div>
