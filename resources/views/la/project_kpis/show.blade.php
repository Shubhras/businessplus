...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $project_kpi->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Project_kpis", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/project_kpis/'.$project_kpi->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Project_kpis", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.project_kpis.destroy', $project_kpi->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/project_kpis') }}" data-toggle="tooltip" data-placement="right" title="Back to Project kpis"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'project_kpi_name')
						@la_display($module, 'project_kpi_dept')
						@la_display($module, 'project_kpi_uom')
						@la_display($module, 'project_kpi_value')
						@la_display($module, 'project_id')
						@la_display($module, 'project_kpi_def')
						@la_display($module, 'project_kpi_trend')
						@la_display($module, 'project_kpi_yr_targt')
						@la_display($module, 'project_kpi_freqency')
					</div>
				</div>
			</div>
		</div>
