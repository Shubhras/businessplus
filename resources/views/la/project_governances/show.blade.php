...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $project_governance->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Project_governances", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/project_governances/'.$project_governance->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Project_governances", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.project_governances.destroy', $project_governance->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/project_governances') }}" data-toggle="tooltip" data-placement="right" title="Back to Project governances"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'agenda')
						@la_display($module, 'meeting_name')
						@la_display($module, 'chair_person')
						@la_display($module, 'co_chair_person')
						@la_display($module, 'gov_frequency')
						@la_display($module, 'gov_venue')
						@la_display($module, 'gov_duration')
						@la_display($module, 'meeting_day')
						@la_display($module, 'meeting_shedule')
