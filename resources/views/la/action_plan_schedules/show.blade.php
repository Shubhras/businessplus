...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $action_plan_schedule->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Action_plan_schedules", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/action_plan_schedules/'.$action_plan_schedule->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Action_plan_schedules", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.action_plan_schedules.destroy', $action_plan_schedule->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/action_plan_schedules') }}" data-toggle="tooltip" data-placement="right" title="Back to Action plan schedules"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'implement_data')
						@la_display($module, 'recovery_plan')
						@la_display($module, 'responsibility')
						@la_display($module, 'action_plan_id')
						@la_display($module, 'month_date')
