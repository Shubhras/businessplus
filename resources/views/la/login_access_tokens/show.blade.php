...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $login_access_token->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Login_access_tokens", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/login_access_tokens/'.$login_access_token->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Login_access_tokens", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.login_access_tokens.destroy', $login_access_token->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/login_access_tokens') }}" data-toggle="tooltip" data-placement="right" title="Back to Login access tokens"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						...
						@la_display($module, 'access_token')
					</div>
				</div>
			</div>
		</div>
