...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $kpi_actual_rview_log->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Kpi_actual_rview_logs", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/kpi_actual_rview_logs/'.$kpi_actual_rview_log->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Kpi_actual_rview_logs", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.kpi_actual_rview_logs.destroy', $kpi_actual_rview_log->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/kpi_actual_rview_logs') }}" data-toggle="tooltip" data-placement="right" title="Back to Kpi actual rview logs"><i class="fa fa-chevron-left"></i></a></li>
