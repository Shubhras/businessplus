...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $software_development->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Software_developments", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/software_developments/'.$software_development->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Software_developments", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.software_developments.destroy', $software_development->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/software_developments') }}" data-toggle="tooltip" data-placement="right" title="Back to Software developments"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'test_software')
					</div>
				</div>
			</div>
		</div>
