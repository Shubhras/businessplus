...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $profile_create_group->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Profile_create_groups", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/profile_create_groups/'.$profile_create_group->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Profile_create_groups", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.profile_create_groups.destroy', $profile_create_group->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/profile_create_groups') }}" data-toggle="tooltip" data-placement="right" title="Back to Profile create groups"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'login_access_token')
						@la_display($module, 'admin_id')
						@la_display($module, 'group_name')
						@la_display($module, 'group_description')
