...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $action_plan_status->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Action_plan_statuses", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/action_plan_statuses/'.$action_plan_status->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Action_plan_statuses", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.action_plan_statuses.destroy', $action_plan_status->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/action_plan_statuses') }}" data-toggle="tooltip" data-placement="right" title="Back to Action plan statuses"><i class="fa fa-chevron-left"></i></a></li>
