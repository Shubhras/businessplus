...
class PostsController extends Controller
{
	...
	public $listing_cols = ['id', 'has_videoposter', 'audio_content', 'video_content', 'content', 'status', 'shared', 'featured', 'album_descr', 'has_album', 'has_audiobground', 'shared_post_id', 'has_ytbVideo', 'has_thyme', 'has_audio', 'has_video', 'has_image', 'page_id', 'group_id', 'timeline_user_id', 'user_id'];
