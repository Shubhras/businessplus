...
class ProjectsController extends Controller
{
	...
	public $listing_cols = ['id', 'project_step_id', 'currency', 'project_logo', 'key_objective', 'project_mission', 'company_id', 'project_cost', 'project_duration', 'project_name', 'unit_id', 'department_id', 'category_id', 'event_id', 'start_date', 'end_date', 'user_id', 'status_id', 'business_init_id', 'enable'];
