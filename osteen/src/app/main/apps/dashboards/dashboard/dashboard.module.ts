...
import { TasktrackerDashboardComponent } from 'app/main/apps/dashboards/dashboard/dashboard.component';
const routes: Routes = [
    {
        path     : '**',
        component: TasktrackerDashboardComponent,
        resolve  : {
...
export class TasktrackerDashboardModule
{
}
