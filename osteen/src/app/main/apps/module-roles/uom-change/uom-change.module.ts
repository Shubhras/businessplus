...
import { UomChangeComponent} from 'app/main/apps/module-roles/uom-change/uom-change.component';
...
import { UomChangeService } from 'app/main/apps/module-roles/uom-change/uom-change.service';
const routes: Routes = [
    {
        path     : '**',
        component: UomChangeComponent,
        resolve  : {
            data: UomChangeService
        }
    }
];
@NgModule({
   ...
   entryComponents : [AddUomDialog,EditUomDialog]
})
export class UomChangeModule
{
}
