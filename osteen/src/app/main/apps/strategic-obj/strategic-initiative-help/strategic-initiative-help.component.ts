...
@Component({
  selector: 'strategic-initiative-help',
  templateUrl: './strategic-initiative-help.component.html',
  styleUrls: ['./strategic-initiative-help.component.scss'],
  encapsulation: ViewEncapsulation.None,
  animations: fuseAnimations
})
export class StrategicInitiativeHelpComponent implements OnInit {
  constructor() { }
