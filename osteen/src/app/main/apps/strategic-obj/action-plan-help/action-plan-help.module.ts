...
import { ActionPlanHelpComponent } from 'app/main/apps/strategic-obj/action-plan-help/action-plan-help.component';
...
const routes: Routes = [
    {
        path: '**',
        component: ActionPlanHelpComponent,
        resolve: {
...
@NgModule({
    ...
    //     DatePipe
    // ],
    //    entryComponents : [EditActionPlanDialog,UserCommentSheet]
})
export class ActionPlanHelpModule {
}
