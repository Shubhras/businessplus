...
import { ViewQtlySummaryComponent} from 'app/main/apps/strategic-obj/view-qtly-summary/view-qtly-summary.component';
...
const routes: Routes = [
    {
        path     : '**',
        component: ViewQtlySummaryComponent,
        resolve  : {
        }
    }
];
...
export class ViewQtlySummaryModule
{
}
