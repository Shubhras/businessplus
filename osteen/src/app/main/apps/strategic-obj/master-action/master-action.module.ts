...
import {MasterActionComponent, ChangeReview, UserCommentSheet } from 'app/main/apps/strategic-obj/master-action/master-action.component';
...
const routes: Routes = [
    {
        path: '**',
        component: MasterActionComponent,
        resolve: {
...
export class MasterActionModule {
}
