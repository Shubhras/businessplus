    ...
    parcels: [
      {
        department_id: '20',
        dept_name: 'Quality',
        description: 'Quality as top priority in entire value chain ',
        end_date: '2021-03-31',
        parcelId: 123,
        parcelName: 'asd',
        parcelItems: [
          {
            definition:
              'Prepare ISO manual including new product launch Quality systems and procedures',
            dept_id: 20,
            dept_name: 'Quality',
            itemId: 2,
            itemName: 'perfume',
          ...
          {
            definition: 'Quality systems and procedures',
            dept_id: 20,
            dept_name: 'Quality',
            itemId: 8,
          ...
          {
            definition: ' systems and procedures',
            dept_id: 20,
            dept_name: 'Quality',
            itemId: 9,
            itemName: 'gum',
      ...
      },
      {
        department_id: '20',
        dept_name: 'Quality',
        description: 'Deliver new launches',
        end_date: '2021-03-31',
        parcelId: 144,
        parcelName: 'parcel2',
        parcelItems: [
          {
            definition: 'test initiative',
            dept_id: 20,
            dept_name: 'Quality',
            itemId: 2,
            itemName: 'headphones',
...
@Component({
  selector: 'app-master-action-plan',
  templateUrl: './master-action-plan.component.html',
  styleUrls: ['./master-action-plan.component.scss'],
  // encapsulation: ViewEncapsulation.None,
  // animations: fuseAnimations

})
export class MasterActionPlanComponent implements OnInit {
  ...
  */
  ...
  filterRenderedData(key: string, value: any) {
    ...
    filteredData = this.strategicAllData.map((dept: any) => {
      ...
      let str = dept.strategic_objectives.filter((so: any) => {
        ...
        /*if(key === "start_date"){
          console.log('if');
           e_date = this.filter.end_date !== '' ? so.end_date >= this.filter.end_date : true;
        }
        else{
           console.log('else');
           e_date = this.filter.end_date !== '' ? so.end_date <= this.filter.end_date : true;
  ...
  actionDataByYear(deptId, strObjId, initiativeId, actionPlanId, selectYear) {
    ...
    //   this.selectYear = selectYear.split('-');
    //   this.selectedyearint = Number(this.selectYear[0]);
    //   console.log("integer", this.selectedyearint);
    // }
    // else {
    //   this.selectYear = selectYear;
    //   //this.selectedyearint = Number(this.selectYear);
    //   console.log("integer", this.selectedyearint);
    // }
