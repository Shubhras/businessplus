...
import { StrategicHelpComponent } from 'app/main/apps/strategic-obj/strategic-help/strategic-help.component';
...
const routes: Routes = [
    {
        path: '**',
        component: StrategicHelpComponent,
        resolve: {
        }
    }
];
...
export class StrategicHelpModule {
}
