...
@Component({
    selector: 'add-opportunities',
    templateUrl: 'addopportunities.component.html',
})
export class AddOpportunities {
    direction = 'row';
    currentUser: any;
    addForm: FormGroup;
    submitted = false;
    ...
    unit_id: any;
    constructor(
        public dialogRef: MatDialogRef<AddOpportunities>,
    ...
    addSubmit() {
        ...
        this.addForm.value.company_id = this.company_id;
        this.addForm.value.unit_id = this.unit_id;

        this.addForm.value.start_date = this.start_date;
        this.addForm.value.end_date = this.end_date;
        this.userService.addOpportunity(this.addForm.value).pipe(first()).subscribe((data: any) => {
