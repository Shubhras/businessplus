...
@Component({
  selector: 'project-kpi-popup-component',
  templateUrl: './project-kpi-popup-component.html',
  encapsulation: ViewEncapsulation.None,
  animations: fuseAnimations
})
export class ProjectKpiPopupComponent {
  direction = 'row';
  currentUser: any;
  project_id: any;
  unit_id;
  ...
  constructor(
    public dialogRef: MatDialogRef<ProjectKpiPopupComponent>,
  ...
  ngOnInit(): void {
    ...
    this.kpiFormGroup = this._formBuilder.group({
      ...
      project_kpi_def: ['', Validators.required],
      project_kpi_trend: ['', Validators.required],
      project_kpi_uom: ['', Validators.required],
      project_kpi_id: [''],
      project_kpi_yr_targt: ['', Validators.required],
      project_kpi_freqency: ['', Validators.required],
      projectDetails: ['kpiProject'],
      project_kpi_value: ['', Validators.required],
      kpi_mile_stone: this._formBuilder.array([this.initKpiMileStone()])
      // milestone_id: [''],
