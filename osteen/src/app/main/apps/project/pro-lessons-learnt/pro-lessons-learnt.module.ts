...
import { ProLessonsLearntComponent} from './pro-lessons-learnt.component';

const routes: Routes = [
    {
        path     : '**',
        component: ProLessonsLearntComponent,
        resolve  : {
...
export class ProLessonsLearntModule
{
}
