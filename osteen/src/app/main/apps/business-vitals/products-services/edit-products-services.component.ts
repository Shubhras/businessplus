...
@Component({
  selector: 'edit-products-services-dialog',
  templateUrl: 'edit-products-services.component.html',
})
export class EditProductsServicesDialog {
    direction = 'row';
    currentUser: any;
    EditDataGet:any;
    editProductsServicesForm: FormGroup;
    submitted = false;
    status_code: any;
    message:any;
    MessageSuccess: any;
    ...
    constructor(
        public dialogRef: MatDialogRef<EditProductsServicesDialog>,
    ...
    editProductsServicesClose(): void {
    ...
    ngOnInit(): void
    {
        ...
        // Reactive Form
        this.editProductsServicesForm = this._formBuilder.group({
    ...
    editProductsServicesSubmit() {
        this.submitted = true;
        // stop here if editProductsServicesForm is invalid
        if (this.editProductsServicesForm.invalid) {
            return;
        }
        this.userService.editPriorityChange(this.editProductsServicesForm.value).pipe(first()).subscribe(
            (data:any) => {
