...
import { MachineFacilityComponent} from './machine-facility.component';
const routes: Routes = [
    {
        path     : '**',
        component: MachineFacilityComponent,
        resolve  : {
...
export class MachineFacilityModule
{
}
