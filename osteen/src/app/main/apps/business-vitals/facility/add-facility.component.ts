...
@Component({
  selector: 'add-facility-dialog',
  templateUrl: 'add-facility.component.html',
})
export class AddFacilityDialog {
    direction = 'row';
    currentUser: any;
    ...
    constructor(
        public dialogRef: MatDialogRef<AddFacilityDialog>,
    ...
    ngOnInit(): void
    {
        ...
        this.addFacilityForm = this._formBuilder.group({
    ...
    addFacilitySubmit() {
        this.submitted = true;
        // stop here if addFacilityForm is invalid
        if (this.addFacilityForm.invalid) {
            return;
        }
       /*  this.userService.addPriorityChange(this.addFacilityForm.value).pipe(first()).subscribe(
            (data:any) => {
