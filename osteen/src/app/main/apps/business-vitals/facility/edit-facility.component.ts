...
@Component({
  selector: 'edit-facility-dialog',
  templateUrl: 'edit-facility.component.html',
})
export class EditFacilityDialog {
    direction = 'row';
    currentUser: any;
    EditDataGet:any;
    ...
    constructor(
        public dialogRef: MatDialogRef<EditFacilityDialog>,
    ...
    ngOnInit(): void
    {
        ...
        // Reactive Form
        this.editFacilityForm = this._formBuilder.group({
    ...
    editFacilitySubmit() {
        this.submitted = true;
        // stop here if editFacilityForm is invalid
        if (this.editFacilityForm.invalid) {
            return;
        }
        this.userService.editPriorityChange(this.editFacilityForm.value).pipe(first()).subscribe(
            (data:any) => {
