...
import { AddGovernanceDialog} from './add-governance.component';
import { EditGovernanceDialog} from './edit-governance.component';
...
@NgModule({
   ...
   entryComponents : [AddGovernanceDialog,EditGovernanceDialog]
})
