...
@Component({
  selector: 'edit-governance-dialog',
  templateUrl: 'edit-governance.component.html',
})
export class EditGovernanceDialog {
    direction = 'row';
    currentUser: any;
    EditDataGet:any;
    editGovernanceForm: FormGroup;
    submitted = false;
    status_code: any;
    message:any;
    MessageSuccess: any;
    ...
    constructor(
        public dialogRef: MatDialogRef<EditGovernanceDialog>,
    ...
    ngOnInit(): void
    {
        ...
        // Reactive Form
        this.editGovernanceForm = this._formBuilder.group({
    ...
    editGovernanceSubmit() {
        this.submitted = true;
        // stop here if editGovernanceForm is invalid
        if (this.editGovernanceForm.invalid) {
            return;
        }
        this.userService.editPriorityChange(this.editGovernanceForm.value).pipe(first()).subscribe(
            (data:any) => {
