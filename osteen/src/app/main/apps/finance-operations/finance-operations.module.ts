...
import { FinanceOperationsComponent} from 'app/main/apps/finance-operations/finance-operations.component';
const routes: Routes = [
    {
        path     : '**',
        component: FinanceOperationsComponent,
        resolve  : {
